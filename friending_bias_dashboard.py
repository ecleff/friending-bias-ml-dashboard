...
st.markdown("Before running rezoning for friending bias, we wanted to confirm if friending bias could be taken as given for a school/district/block, or if there were demographic characteristics that directly predicted friending bias on the school level.")
...
error_bars = test_results_bar.mark_rule().encode(
    x='type:N',
    y='lower_CI:Q',
    y2= 'upper_CI:Q'
